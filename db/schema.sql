...
ALTER TABLE users ADD COLUMN IF NOT EXISTS wallet_balance_usd NUMERIC(18, 2) NOT NULL DEFAULT 0;
...
ALTER TABLE collections ADD COLUMN IF NOT EXISTS image_url VARCHAR(2000);

ALTER TABLE items ADD COLUMN IF NOT EXISTS is_public BOOLEAN NOT NULL DEFAULT FALSE;
ALTER TABLE items ALTER COLUMN image_url TYPE VARCHAR(2000);
